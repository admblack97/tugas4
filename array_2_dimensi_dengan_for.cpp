...
int main() {
	...
	cout.precision(4);	
	//1# Matrix - Isi dan Tampilan Data
	cout << "MATRIKS X : "<<endl;
	double ac[3][5]= {
	{4,4,5,3,3},
	{3,3,4,2,3},
	...
	//Menentukan nilai max tiap kreteria
	cout<<endl<<"MATRIKS R : "<<endl;
	double mc[5];
	for(int i=0;i<5;i++) {
		mc[i+1]=max(ac[0][i],max(ac[1][i],ac[2][i]));
	}
	//Matrix R - Nilai dan Menampilkan Data
	double Rac[3][5]={
	{(ac[0][0]/mc[1]), (ac[0][1]/mc[2]), (ac[0][2]/mc[3]), (ac[0][3]/mc[4]), (ac[0][4]/mc[5])},
